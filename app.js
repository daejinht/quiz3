...
document.getElementById('quizForm').addEventListener('submit', async function(event) {
    ...
    try {
        ...
        const q1_raw_inputs = [
            document.getElementById('q1_in_1').value, 
            document.getElementById('q1_in_2').value,
            document.getElementById('q1_in_3').value, 
            document.getElementById('q1_in_4').value, 
            document.getElementById('q1_in_5').value
        ];
        ...
        const q4_in_1_el = document.getElementById('q4_in_1');
        const q4_in_2_el = document.getElementById('q4_in_2');
        const q4_raw_1 = q4_in_1_el ? q4_in_1_el.value : "";
        const q4_raw_2 = q4_in_2_el ? q4_in_2_el.value : "";
        
        userAnswers.ans4 = `명칭:${q4_raw_1}, 교체주기:${q4_raw_2}`;

        const q4_1 = q4_raw_1.replace(/\s+/g, '').toLowerCase();
        const q4_2 = q4_raw_2.replace(/\s+/g, '').toLowerCase();

        const q4_1_answers = ["정화통", "필터", "정화통(필터)", "6006k", "6006K"]; 
        ...
        const q8_in_1_el = document.getElementById('q8_in_1');
        const q8_in_2_el = document.getElementById('q8_in_2');
        const q8_in_3_el = document.getElementById('q8_in_3');
        const q8_in_4_el = document.getElementById('q8_in_4');
        const q8_raw_1 = q8_in_1_el ? q8_in_1_el.value : "";
        const q8_raw_2 = q8_in_2_el ? q8_in_2_el.value : "";
        const q8_raw_3 = q8_in_3_el ? q8_in_3_el.value : "";
        const q8_raw_4 = q8_in_4_el ? q8_in_4_el.value : "";
        ...
        const q10_in_1_el = document.getElementById('q10_in_1');
        const q10_in_2_el = document.getElementById('q10_in_2');
        const q10_raw_1 = q10_in_1_el ? q10_in_1_el.value : "";
        const q10_raw_2 = q10_in_2_el ? q10_in_2_el.value : "";
        ...
        const payload = {
            ...
            ans1: userAnswers.ans1, 
            ans2: userAnswers.ans2, 
            ans3: userAnswers.ans3,
            ans4: userAnswers.ans4, 
            ans5: userAnswers.ans5, 
            ans6: userAnswers.ans6,
            ans7: userAnswers.ans7, 
            ans8: userAnswers.ans8, 
            ans9: userAnswers.ans9, 
            ans10: userAnswers.ans10
        };
        ...
        alert("일시적인 오류가 발생했습니다. 빈칸이 없는지 확인 후 다시 눌러주세요.");
        submitBtn.innerText = "제출하기";
        submitBtn.disabled = false;
    }
});
